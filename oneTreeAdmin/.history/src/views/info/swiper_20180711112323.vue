     ...
     <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          ...
          <el-button type="warning" icon="el-icon-info" @click="forbid(scope.row)" v-if="scope.row.isforbid==1">禁用</el-button>
          <el-button type="success" icon="el-icon-info" @click="forbid(scope.row)" v-else>启用</el-button>
...
<script>
import { upPic, addswiper, getlist, delOne, forbid } from '@/api/info'
